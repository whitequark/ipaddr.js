...
export const fromByteArray = ipaddr.fromByteArray;
export const isValid = ipaddr.isValid;
export const parse = ipaddr.parse;
export const parseCIDR = ipaddr.parseCIDR;
export const process = ipaddr.process;
export const subnetMatch = ipaddr.subnetMatch;
export const isValidCIDR = ipaddr.isValidCIDR;