...
module.exports =
  ...
  'mask2CIDR returns proper CIDR notation for standard IPv4 masks': (test) ->
    test.equal(ipaddr.IPv4.parse('255.255.255.255').mask2CIDR(), 32)
    test.equal(ipaddr.IPv4.parse('255.255.255.254').mask2CIDR(), 31)
    test.equal(ipaddr.IPv4.parse('255.255.255.252').mask2CIDR(), 30)
    test.equal(ipaddr.IPv4.parse('255.255.255.248').mask2CIDR(), 29)
    test.equal(ipaddr.IPv4.parse('255.255.255.240').mask2CIDR(), 28)
    test.equal(ipaddr.IPv4.parse('255.255.255.224').mask2CIDR(), 27)
    test.equal(ipaddr.IPv4.parse('255.255.255.192').mask2CIDR(), 26)
    test.equal(ipaddr.IPv4.parse('255.255.255.128').mask2CIDR(), 25)
    test.equal(ipaddr.IPv4.parse('255.255.255.0').mask2CIDR(), 24)
    test.equal(ipaddr.IPv4.parse('255.255.254.0').mask2CIDR(), 23)
    test.equal(ipaddr.IPv4.parse('255.255.252.0').mask2CIDR(), 22)
    test.equal(ipaddr.IPv4.parse('255.255.248.0').mask2CIDR(), 21)
    test.equal(ipaddr.IPv4.parse('255.255.240.0').mask2CIDR(), 20)
    test.equal(ipaddr.IPv4.parse('255.255.224.0').mask2CIDR(), 19)
    test.equal(ipaddr.IPv4.parse('255.255.192.0').mask2CIDR(), 18)
    test.equal(ipaddr.IPv4.parse('255.255.128.0').mask2CIDR(), 17)
    test.equal(ipaddr.IPv4.parse('255.255.0.0').mask2CIDR(), 16)
    test.equal(ipaddr.IPv4.parse('255.254.0.0').mask2CIDR(), 15)
    test.equal(ipaddr.IPv4.parse('255.252.0.0').mask2CIDR(), 14)
    test.equal(ipaddr.IPv4.parse('255.248.0.0').mask2CIDR(), 13)
    test.equal(ipaddr.IPv4.parse('255.240.0.0').mask2CIDR(), 12)
    test.equal(ipaddr.IPv4.parse('255.224.0.0').mask2CIDR(), 11)
    test.equal(ipaddr.IPv4.parse('255.192.0.0').mask2CIDR(), 10)
    test.equal(ipaddr.IPv4.parse('255.128.0.0').mask2CIDR(), 9)
    test.equal(ipaddr.IPv4.parse('255.0.0.0').mask2CIDR(), 8)
    test.equal(ipaddr.IPv4.parse('254.0.0.0').mask2CIDR(), 7)
    test.equal(ipaddr.IPv4.parse('252.0.0.0').mask2CIDR(), 6)
    test.equal(ipaddr.IPv4.parse('248.0.0.0').mask2CIDR(), 5)
    test.equal(ipaddr.IPv4.parse('240.0.0.0').mask2CIDR(), 4)
    test.equal(ipaddr.IPv4.parse('224.0.0.0').mask2CIDR(), 3)
    test.equal(ipaddr.IPv4.parse('192.0.0.0').mask2CIDR(), 2)
    test.equal(ipaddr.IPv4.parse('128.0.0.0').mask2CIDR(), 1)
    test.equal(ipaddr.IPv4.parse('0.0.0.0').mask2CIDR(), 0)
    test.done()
