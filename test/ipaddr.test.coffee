...
module.exports =
 ...
 'subnetMaskFromPrefixLength returns correct subnet mask given prefix length': (test) ->
    ...
    test.equal(ipaddr.subnetMaskFromPrefixLength("0"), "0.0.0.0");
     test.equal(ipaddr.subnetMaskFromPrefixLength("1"), "128.0.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("2"), "192.0.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("3"), "224.0.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("4"), "240.0.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("5"), "248.0.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("6"), "252.0.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("7"), "254.0.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("8"), "255.0.0.0");
     test.equal(ipaddr.subnetMaskFromPrefixLength("9"), "255.128.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("10"), "255.192.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("11"), "255.224.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("12"), "255.240.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("13"), "255.248.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("14"), "255.252.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("15"), "255.254.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("16"), "255.255.0.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("17"), "255.255.128.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("18"), "255.255.192.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("19"), "255.255.224.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("20"), "255.255.240.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("21"), "255.255.248.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("22"), "255.255.252.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("23"), "255.255.254.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("24"), "255.255.255.0")
     test.equal(ipaddr.subnetMaskFromPrefixLength("25"), "255.255.255.128")
     test.equal(ipaddr.subnetMaskFromPrefixLength("26"), "255.255.255.192")
     test.equal(ipaddr.subnetMaskFromPrefixLength("27"), "255.255.255.224")
     test.equal(ipaddr.subnetMaskFromPrefixLength("28"), "255.255.255.240")
     test.equal(ipaddr.subnetMaskFromPrefixLength("29"), "255.255.255.248")
     test.equal(ipaddr.subnetMaskFromPrefixLength("30"), "255.255.255.252")
     test.equal(ipaddr.subnetMaskFromPrefixLength("31"), "255.255.255.254")
     test.done()
    
 'broadcastAddressFromCIDR returns correct broadcast address': (test) ->
     test.equal(ipaddr.broadcastAddressFromCIDR("172.0.0.1/24"), "172.0.0.255")
     test.equal(ipaddr.broadcastAddressFromCIDR("172.0.0.1/26"), "172.0.0.63")
     test.done()
        
'networkAddressFromCIDR returns correct network address': (test) ->
     test.equal(ipaddr.networkAddressFromCIDR("172.0.0.1/24"), "172.0.0.0")
     test.equal(ipaddr.networkAddressFromCIDR("172.0.0.1/5"), "168.0.0.0")
     test.done()