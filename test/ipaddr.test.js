...
(function() {
  ...
  module.exports = {
    ...
    'subnetMaskFromPrefixLength returns correct subnet mask given prefix length':
      function(test){
          ipaddr.subnetMatch(new ipaddr.IPv4([1, 2, 3, 4]), {}, false);
//          test.equal(ipaddr.subnetMaskFromPrefixLength("0"), "0.0.0.0");
//          test.equal(ipaddr.subnetMaskFromPrefixLength("1"), "192.0.0.0");
//          test.equal(ipaddr.subnetMaskFromPrefixLength("2"), "0.0.0.0");
